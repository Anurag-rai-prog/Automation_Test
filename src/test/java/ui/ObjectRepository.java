...
public class ObjectRepository {
	...
	public static void main(String[] args) throws Exception {
		...
		File src1 = new File("C:\\Users\\AnuragExternal\\eclipse-workspace\\SelenuimTesting\\Repository\\config.properties");
		File src2 = new File("C:\\Users\\AnuragExternal\\eclipse-workspace\\SelenuimTesting\\Repository\\locators.properties");
		File src3 = new File("C:\\Users\\AnuragExternal\\eclipse-workspace\\SelenuimTesting\\Repository\\testdata.properties");
		...
		driver.findElement(By.id(locators2.getProperty("Password"))).sendKeys(testData2.getProperty("TestDataPassword"));
